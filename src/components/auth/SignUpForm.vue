    ...
    <q-card-section horizontal>
      ...
      <q-card-section>
        ...
        <q-form @submit="register" autofocus class="q-gutter-y-md text-center">
          ...
          <q-input type="password" placeholder="Confirmer le mot de passe" v-model="form.repeat" lazy-rules :rules="[
            val => val !== null && val !== '' || 'Champs requis',
            val => val === form.password || 'Les mots de passe ne correspondent pas'
          ]" />
          <q-btn type="submit" class="full-width" unelevated color="positive" size="lg" label="Créer mon compte">
          </q-btn>
